                ...
                <div className="sm:flex">
                    <div>
                        <p className="mt-2 mb-2 text-xl">
                            The Sylar Project is a curated list of mental health resources organized
                            by location. Our mission is to make it was easy as possible for you to
                            find your local mental health resources so you can focus on what's
                            import, you.
                        </p>
                    </div>
                </div>
