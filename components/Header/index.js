    ...
    <section className="py-12 px-4 text-center pb-0">
        ...
        <div className="max-w-2xl mx-auto">
            <img
                ...
                src="https://images.unsplash.com/photo-1492681290082-e932832941e6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1651&q=80"
                alt="banner"
            />
            ...
            <div>
                <p className="text-black-400 text-xl leading-relaxed mt-10">
                    ...
                    and help make the Syler Project an incredible resource. Filter for your location
                    below to see resources in your state
                </p>
            </div>
        </div>
    </section>
