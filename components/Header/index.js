...
const Header = () => (
  <section className="py-12 px-4 text-center pb-0">
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div>
        <p className="text-black-400 text-xl leading-relaxed mt-10">The Syler Project aims to be a resource for locating local mental health resources no matter where you live. It's important that any and all existing mental health resources are easy to find and as accesible as possible. This is an open source project that is in need of contributers. Check out the repo here and help make the Syler Project an incredible resource. Filter for your location below to see resources in your state</p>
      </div>
    </div>
  </section>
)
